...
def rgb2yuv(image):
    """
    convert image from RGB to YUV (From Nvidia paper)
    """
...
def translate_random(image, angle, range_x, range_y):
    """
    shift image virtically and horizontally randomly
    """
...
def rand_shadow(image):
    """
    generate & add random shadow
    """
...
def rand_bright(image):
    """
    Adjust random image brightness
    """
            ...
            for batch_sample in batch_samples:
                ...
                for i in range(3):
                    ...
                    if is_training:
                        ...
                        image, measurement = translate_random(image, measurement, x_translate_range, y_translate_range)
                        image = rand_shadow(image)
